...
const simpanContact = (nama, email, noHP) => {
    ...
    console.log(chalk.greenBright.inverse.bold("Terima kasih sudah memasukkan data."));
    };
...
const deleteContact = (nama) => {
    ...
    console.log(chalk.greenBright.inverse.bold(`Data contact ${nama} berhasil dihapus!`));
